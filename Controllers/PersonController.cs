...
namespace NguyenThaoNguyen_BTH2.Controllers
{
    public class PersonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Age,Sđt,Sothich")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Age,Sđt,Sothich")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
