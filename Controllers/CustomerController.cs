...
namespace NguyenThaoNguyen_BTH2.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MaKH,CoQuan,Diachi,Sđt")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MaKH,CoQuan,Diachi,Sđt")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
